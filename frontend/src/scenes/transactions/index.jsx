...
const Transactions = () => {
  ...
  const handleAddTransaction = async () => {
    try {
      // Make the API call to add a new transaction
      // await createTransactionMutation.mutateAsync(newTransactionData);

      // Close the dialog
      handleCloseAddDialog();

      // Optionally, you can refetch the data to update the transactions list
    } catch (error) {
  ...
  return (
    <Box m="1.5rem 2.5rem">
      ...
      <Dialog open={openAddDialog} onClose={console.log(1)}>
        ...
        <DialogContent>
          ...
          />
          {/* Other input fields for products, cost, etc. */}
